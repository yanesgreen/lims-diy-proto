...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-5">
        <h4 class="mb-0 text-gray-800 d-none d-md-block">Daftar Bidang</h4>
        <a role="button" href="{{ route('bidang.create') }}" title="Tambah Bidang"
        ...
        $(document).ready(function () {
            ...
            $('#requestTable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'nama', name: 'nama', class: 'text-capitalize'},
                    {data: 'singkatan', name: 'singkatan'},
                    {data: 'subbidang_list', name: 'subbidang_list', class: 'text-center', orderable: false},
