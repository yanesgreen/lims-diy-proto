                    ...
                    <div id="body-7" class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10 pt-2">
                                {{--BAP Laboratoris--}}
                                <div class="form-group form-check">
                                    <input type="checkbox" class="form-check-input" nama="bap_laboratoris">
                                    <label class="form-check-label" for="exampleCheck1">BAP Laboratoris</label>
                                </div>
                                {{--BB--}}
                                <div class="form-group form-check">
                                    <input type="checkbox" class="form-check-input" nama="bb_diserahkan">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10 pt-2">
                                ...
                                <div class="form-group form-check">
                                    ...
                                    <label class="form-check-label" for="exampleCheck1">BB</label>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <h5 class="mb-0 font-weight-light text-muted mb-5">
                        Laporan Laboratoris dan BAP Telah Diterima
                    </h5>
                    <hr>
                    <a role="button" href="{{ route("dashboard.urtu2") }}"
