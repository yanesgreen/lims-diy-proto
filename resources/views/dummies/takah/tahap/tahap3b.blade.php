...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a class="btn btn-danger" href="{{ route('dashboard.urtu2') }}" role="button">
            Kembali
        </a>
    </div>
    ...
    <div class="shadow mb-3">
        ...
        <div class="card">
            <div class="card-header bg-primary" id="headingFour">
                <p class="mb-0 text-white" id="collapseFour-text">
                    7. Pengecekan BAP Laboratoris dan Barang Bukti
                </p>
            </div>
            <div>
                <div id="body-7" class="card-body">
                    {{--Yang Diserahkan--}}
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 pt-2">
                            {{--BAP Laboratoris--}}
                            <div class="form-group form-check">
                                <input type="checkbox" class="form-check-input" nama="bap_laboratoris" checked>
                                <label class="form-check-label" for="exampleCheck1">BAP Laboratoris</label>
                            </div>
                            {{--BB--}}
                            <div class="form-group form-check">
                                <input type="checkbox" class="form-check-input" nama="bb_diserahkan" checked>
                                <label class="form-check-label" for="exampleCheck1">Barang Bukti</label>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div>
                <div id="body-8" class="card-body">
                    {{--form start--}}
                    <form id="form-create-penyerahan_bb"
                          method="post"
                          action=""
                        ...
                        <div class="d-flex justify-content-end mb-3">
                            <button id="btn-8" class="btn btn-lims-gradient d-flex align-content-center">
                                Selanjutnya
                                <i id="loader-tiket"
        ...
        <div class="card">
            ...
            <div>
                <div id="body-9" class="card-body" style="display: none">
                    {{--Pertanyaan 1--}}
                    <div class="form-group row">
                        <label for="select-jenisidentitas" class="col-lg-2 col-form-label text-lg-right">
                            Pertanyaan 1:
                        ...
                        <div class="col-lg-10">
                            <label class="col-form-label">
                                Petugas Puslabfor ramah dalam pelayanannya?
                            </label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="radios1" value="option1">
                                <label class="form-check-label" for="exampleRadios1">
                                    Sangat Puas
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="radios1" value="option2">
                                <label class="form-check-label" for="exampleRadios2">
                                    Puas
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="radios1" value="option3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <label class="col-form-label">
                                Petugas Puslabfor tepat waktu dalam pelayanannya?
                            </label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="radios2" value="option1">
                                <label class="form-check-label" for="exampleRadios1">
                                    Sangat Puas
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="radios2" value="option2">
                                <label class="form-check-label" for="exampleRadios2">
                                    Puas
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="radios2" value="option3">
                                <label class="form-check-label" for="exampleRadios3">
                                    Kurang Puas
                                </label>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <label class="col-form-label">
                                Petugas Puslabfor cepat datang bila diminta bantuan pemeriksaan?
                            </label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="radios3" value="option1">
                                <label class="form-check-label" for="exampleRadios1">
                                    Sangat Puas
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="radios3" value="option2">
                                <label class="form-check-label" for="exampleRadios2">
                                    Puas
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="radios3" value="option3">
                                <label class="form-check-label" for="exampleRadios3">
                                    Kurang Puas
                                </label>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <label class="col-form-label">
                                Petugas Puslabfor terampil melakukan pemeriksaan di lapangan?
                            </label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="radios4" value="option1">
                                <label class="form-check-label" for="exampleRadios1">
                                    Sangat Puas
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="radios4" value="option2">
                                <label class="form-check-label" for="exampleRadios2">
                                    Puas
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="radios4" value="option3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <label class="col-form-label">
                                Petugas Puslabfor mudah dihubungi oleh Penyidik?
                            </label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="radios5" value="option1">
                                <label class="form-check-label">
                                    Sangat Puas
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="radios5" value="option2">
                                <label class="form-check-label">
                                    Puas
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="radios5" value="option3">
                                <label class="form-check-label">
                                    Kurang Puas
                                </label>
                            </div>
            ...
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <h5 class="mb-0 font-weight-light text-muted mb-5">
                        Laporan Laboratoris dan BAP Telah Diserahkan Ke Penyidik/Penerima
                    </h5>
                    <hr>
                    <a role="button" href="{{ route("dummies.takah.cetakan.penyerahan") }}"
                       class="btn btn-lims-gradient">
                        Lihat Dokumen Penyerahan Barang Bukti
                    </a>
                </div>
            </div>
        </div>
