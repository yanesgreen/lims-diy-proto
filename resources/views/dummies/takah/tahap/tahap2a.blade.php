    ...
    <script defer>
        $(document).ready(function () {
            ...
            $('#kelengkapan_formil').on('change', function () {
                const val = $(this).val();
                if (val === "lengkap") {
                    $('#keterangan_formil').attr({"disabled": true});
                } else {
                    $('#keterangan_formil').attr({"disabled": false});
                }
            });
            ...
            $('#kelengkapan_teknis').on('change', function () {
                const val = $(this).val();
                if (val === "lengkap") {
                    $('#keterangan_teknis').attr({"disabled": true});
                } else {
                    $('#keterangan_teknis').attr({"disabled": false});
                }
            });
