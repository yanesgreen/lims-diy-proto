...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-5">
        ...
        {{--Judul halaman--}}
        <h4 class="mb-0 text-primary d-none d-md-block">Daftar Polsek</h4>

        {{--Button tambah jabatan baru--}}
        <a role="button"
           href="{{ route('polsek.create') }}"
           title="Tambah Polsek"
        ...
        <div class="col-12">
            ...
            <table id="requestTable" style="width: 100%;"
                ...
                <tr>
                    ...
                    <th style="width: 7em">Nama Polsek</th>
                    <th>Alamat</th>
                    <th>Telepon</th>
        ...
        $(document).ready(function () {
            ...
            $('#requestTable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'polres', name: 'polres', orderable: true, searchable: false},
                    {data: 'nama', name: 'nama'},
