...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-5">
        ...
        {{--Judul halaman--}}
        <h4 class="mb-0 text-gray-800 d-none d-md-block">Daftar Pangkat</h4>

        {{--Button tambah jabatan baru--}}
        <a role="button"
           href="{{ route('pangkat.create') }}"
        ...
        $(document).ready(function () {
            ...
            $('#requestTable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'singkatan', name: 'singkatan', orderable: true},
