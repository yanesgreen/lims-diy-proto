...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-5">
        <h4 class="mb-0 text-primary d-none d-md-block">Daftar Satker Mabes Polri</h4>
        <a role="button" href="{{ route('satker.create') }}" title="Tambah Satker Mabes Polri"
           class="btn btn-primary modal-show">
            Tambah Satker Mabes Polri
        </a>
    </div>
