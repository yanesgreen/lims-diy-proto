                    ...
                    <div class="d-flex justify-content-between mt-5 mb-3">
                        ...
                        <div>
                            ...
                            <a class="btn btn-primary"
                               href="{{ route('visual_grafis.tabulasi.kasus_menonjol', ['waktu' => $waktu, 'unitkerja' => $unitkerja]) }}"
                               role="button">
                                Tabulasi
                            </a>
                        </div>
    ...
    <script>
        $(function () {
            ...
            const chart = Highcharts.chart('grafik', {
                ...
                title: {
                    text: 'Statistik Kasus Menonjol {{ ucfirst($waktu) }} {{ \App\UnitKerja::find($unitkerja)->nama }}'
                },
                @if( $waktu == 'harian')
                subtitle: {
                ...
                series: [
                    {
                        ...
                        data: [
                            ...
                            {
                                name: "Kasus Tidak Menonjol",
                                y: {{ $kasus_tidak_menonjol }},
