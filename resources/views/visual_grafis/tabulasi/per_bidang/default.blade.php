            ...
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <h4 class="text-center mb-1">
                        Statistik Pemeriksaan <span class="text-capitalize">{{$waktu}}</span> Per Bidang
                    </h4>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>1</td>
                            <td>Fiskomfor</td>
                            <td>{{ $jumlah_fiskomfor }}</td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>Narkobafor</td>
                            <td>{{ $jumlah_narkobafor }}</td>
                        </tr>
                        <tr>
                            <td>3</td>
                            <td>Dokupalfor</td>
                            <td>{{ $jumlah_dokupalfor }}</td>
                        </tr>
                        <tr>
                            <td>4</td>
                            <td>Kimbiofor</td>
                            <td>{{ $jumlah_kimbiofor }}</td>
                        </tr>
                        <tr>
                            <td>5</td>
                            <td>Balmetfor</td>
                            <td>{{ $jumlah_balmetfor }}</td>
                        </tr>
                        <tr class="bg-light">
