            ...
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <h4 class="text-center mb-1">
                        ...
                        Per Pemeriksa Bidang {{ ucfirst(\App\Bidang::find($bidang_id)->singkatan) }}
                    </h4>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th classs="text-center">Total Takah Diperiksa</th>
                        </tr>
                        </thead>
                        <tbody>
                    ...
                    <div id="action_buttons_container" class="d-flex justify-content-between mt-5 mb-3">
                        ...
                        <div>
                            ...
                            <a class="btn btn-primary"
                               href="{{ route('visual_grafis.grafik.perpemeriksa', [
                               'waktu' => $waktu,
                               'unitkerja' => $unitkerja,
                               'bidang_id' => $bidang_id])
                               }}"
