<form id="form-simpan-takah-2"
    ...
    {{--Barang Bukti 1--}}
    <div class="row">
        <label class="col-lg-2 col-form-label text-lg-right">Barang Bukti 1</label>
        <div class="col-lg-3">
            <div class="form-group">
                ...
                <small id="helper-jenisbb1_id" class="form-text text-danger"></small>
            </div>
        </div>
        <div class="col-lg-3">
            <div class="form-group">
                <input type="text" name="jumlahbb1" id="jumlahbb1" class="form-control"
                       placeholder="Jumlah Barang Bukti">
                <small id="helper-jumlahbb1" class="form-text text-danger"></small>
            </div>
        </div>
        <div class="col-lg-3">
            <div class="form-group">
                <input type="number"
                       ...
                       step="any"
                       class="form-control"
                       placeholder="Berat Barang Bukti">
                <small id="helper-beratbb1" class="form-text text-danger">
                    <span class="text-muted"></span>
                </small>
            </div>
        </div>
        <div class="col-lg-1">
            <button id="btn-clear-bb1" type="button" class="btn btn-primary">hapus</button>
        </div>
    </div>

    {{--Barang Bukti 2--}}
    <div class="row">
        <label class="col-lg-2 col-form-label text-lg-right">Barang Bukti 2</label>
        <div class="col-lg-3">
            <div class="form-group">
                <select class="form-control select2"
                        id="jenisbb2"
                ...
                <small id="helper-jenisbb2_id" class="form-text text-danger"></small>
            </div>
        </div>
        <div class="col-lg-3">
            <div class="form-group">
                <input type="text" name="jumlahbb2" id="jumlahbb2" class="form-control"
                       placeholder="Jumlah Barang Bukti">
                <small id="helper-jumlahbb2" class="form-text text-danger"></small>
            </div>
        </div>
        <div class="col-lg-3">
            <div class="form-group">
                <input type="number" name="beratbb2" id="beratbb2" class="form-control"
                       placeholder="Berat Barang Bukti">
                <small id="helper-beratbb2" class="form-text text-danger">
                    <span class="text-muted"></span>
                </small>
            </div>
        </div>
        <div class="col-lg-1">
            <button id="btn-clear-bb2" type="button" class="btn btn-primary">hapus</button>
        </div>
    </div>

    {{--Barang Bukti 3--}}
    <div class="row">
        <label class="col-lg-2 col-form-label text-lg-right">Barang Bukti 3</label>
        <div class="col-lg-3">
            <div class="form-group">
                <select class="form-control select2"
                        id="jenisbb3"
                ...
                <small id="helper-jenisbb3_id" class="form-text text-danger"></small>
            </div>
        </div>
        <div class="col-lg-3">
            <div class="form-group">
                <input type="text" name="jumlahbb3" id="jumlahbb3" class="form-control"
                       placeholder="Jumlah Barang Bukti">
                <small id="helper-jumlahbb3" class="form-text text-danger"></small>
            </div>
        </div>
        <div class="col-lg-3">
            <div class="form-group">
                <input type="number" name="beratbb3" id="beratbb3" class="form-control"
                       placeholder="Berat Barang Bukti">
                <small id="helper-beratbb3" class="form-text text-danger">
                    <span class="text-muted"></span>
                </small>
            </div>
        </div>
        <div class="col-lg-1">
            <button id="btn-clear-bb3" type="button" class="btn btn-primary">hapus</button>
        </div>
    </div>

    {{--Barang Bukti 4--}}
    <div class="row">
        <label class="col-lg-2 col-form-label text-lg-right">Barang Bukti 4</label>
        <div class="col-lg-3">
            <div class="form-group">
                <select class="form-control select2"
                        id="jenisbb4"
                ...
                <small id="helper-jenisbb4_id" class="form-text text-danger"></small>
            </div>
        </div>
        <div class="col-lg-3">
            <div class="form-group">
                <input type="text" name="jumlahbb4" id="jumlahbb4" class="form-control"
                       placeholder="Jumlah Barang Bukti">
                <small id="helper-jumlahbb4" class="form-text text-danger"></small>
            </div>
        </div>
        <div class="col-lg-3">
            <div class="form-group">
                <input type="number" name="beratbb4" id="beratbb4" class="form-control"
                       placeholder="Berat Barang Bukti">
                <small id="helper-beratbb4" class="form-text text-danger">
                    <span class="text-muted"></span>
                </small>
            </div>
        </div>
        <div class="col-lg-1">
            <button id="btn-clear-bb4" type="button" class="btn btn-primary">hapus</button>
        </div>
    </div>
    ...
    {{--Tersangka 1--}}
    <div class="form-group row">
        <label class="col-lg-2 col-form-label text-lg-right">Tersangka/Terlapor</label>
        <div class="col-lg-10">
            <input type="text"
                   id="tersangka1"
                   name="tersangka1"
