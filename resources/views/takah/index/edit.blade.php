...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-5">
        ...
        {{--Judul halaman--}}
        <h4 class="mb-0 text-gray-800 d-none d-md-block">Takah Yang Dapat Di Edit</h4>
        ...
        <div class="col-12">
            ...
            <table id="requestTable"
                ...
                <tr>
                    ...
                    <th style="width: 30%">Dapat Diedit Oleh NRP</th>
...
@section('localscript')
    <script>
        $(document).ready(function () {
            //datatable
            const url = '{{ route('takah.api.edit') }}';
