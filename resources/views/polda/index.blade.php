...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-5">
        ...
        {{--Judul halaman--}}
        <h4 class="mb-0 text-primary d-none d-md-block">Daftar Polda</h4>

        {{--Button tambah jabatan baru--}}
        <a role="button"
           href="{{ route('polda.create') }}"
           title="Tambah Polda"
        ...
        $(document).ready(function () {
            ...
            $('#requestTable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'telepon', name: 'bidang', orderable: true, searchable: false},
                    {data: 'nomorurut', name: 'nomorurut', class: 'd-none'},
