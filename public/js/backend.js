...
__webpack_require__(/*! flatpickr/dist/l10n/id */ "./node_modules/flatpickr/dist/l10n/id.js");
...
$(document).ready(function () {
  ...
  $(document).on('click', '.modal-show', function (event) {
    ...
    $('#modal-header').css("background-color", "#0b4953"); // ajax to call form
    ...
    $.ajax({
      ...
      error: function error(jqXHR, textStatus, _error) {
        $('#modal-body').text('Error: Form tidak dapat ditampilkan.' + _error);
      },
    ...
    $('.btn-simpan').one('click', function () {
      ...
      var store_url = form.attr('action');
  ...
  $('body').on('click', '.btn-edit', function (event) {
    ...
    $('#modal-title').text(title);
    $('#modal-header').css("background-color", "#141E30"); // ajax to call form
    ...
    $.ajax({
      ...
      error: function error(jqXHR, textStatus, _error2) {
        $('#modal-body').text('Error: Form tidak dapat ditampilkan.' + _error2);
      },
      success: function success(data) {
        $('#modal-body').html(data);
      },
  ...
  $('body').on('click', '.btn-delete', function (event) {
    ...
    $('#modal-title').text(title);
    $('#modal-header').css("background-color", "crimson"); // ajax to call form
    ...
    $.ajax({
      ...
      error: function error(jqXHR, textStatus, _error3) {
        $('#modal-body').text('Error: Form tidak dapat ditampilkan.' + _error3);
      },
      success: function success(data) {
        $('#modal-body').html(data);
      },
  ...
  $('#form-simpan-takah-1').submit(function (event) {
    event.preventDefault();
    event.stopImmediatePropagation();
    var form = $('#form-simpan-takah-1')[0];
    var data = new FormData(form);
    var formSimpanTakah = $('#form-simpan-takah-1');
    var insert_url = formSimpanTakah.attr('action');
    var method = formSimpanTakah.attr('method');
    $.ajax({
      type: method,
  ...
  $('#form-simpan-takah-2').submit(function (event) {
    event.preventDefault();
    event.stopImmediatePropagation();
    var form = $('#form-simpan-takah-2')[0];
    var data = new FormData(form);
    var formSimpanTakah = $('#form-simpan-takah-2');
    var insert_url = formSimpanTakah.attr('action');
    var method = formSimpanTakah.attr('method');
    $.ajax({
      type: method,
  ...
  $('#form-serahkan-ke-kaurmin').submit(function (event) {
    event.preventDefault();
    var form = $('#form-serahkan-ke-kaurmin');
    var url = form.attr('action');
    var method = form.attr('method');
    $.ajax({
      url: url,
  ...
  $('#form-tambah-keterangan-takah').submit(function (event) {
    event.preventDefault();
    var form = $('#form-tambah-keterangan-takah');
    var url = form.attr('action');
    var method = form.attr('method');
    $.ajax({
      url: url,
  ...
  $('#form-tambah-pemeriksa').submit(function (event) {
    event.preventDefault();
    var form = $('#form-tambah-pemeriksa');
    var url = form.attr('action');
    var method = form.attr('method');
    $.ajax({
      url: url,
  ...
  $('#form-simpan-bap').submit(function (event) {
    event.preventDefault();
    event.stopImmediatePropagation();
    var form = $('#form-simpan-bap')[0];
    var data = new FormData(form);
    var formSimpanBap = $('#form-simpan-bap');
    var insert_url = formSimpanBap.attr('action');
    var method = formSimpanBap.attr('method');
    $.ajax({
      type: method,
      enctype: 'multipart/form-data',
      url: insert_url,
  ...
  $('#form-tambah-dokumen-diserahkan').submit(function (event) {
    event.preventDefault();
    var form = $('#form-tambah-dokumen-diserahkan');
    var url = form.attr('action');
    var method = form.attr('method');
    $.ajax({
      url: url,
  ...
  $('#form-simpan-penyidik-penerima').submit(function (event) {
    event.preventDefault();
    event.stopImmediatePropagation();
    var form = $('#form-simpan-penyidik-penerima')[0];
    var data = new FormData(form);
    var formPenyidikPenerima = $('#form-simpan-penyidik-penerima');
    var insert_url = formPenyidikPenerima.attr('action');
    var method = formPenyidikPenerima.attr('method');
    var loader = $('#loader-simpan-penyidik-penerima');
    $.ajax({
      type: method,
      enctype: 'multipart/form-data',
      url: insert_url,
  ...
  $('#form-simpan-feedback').submit(function (event) {
    event.preventDefault();
    event.stopImmediatePropagation();
    var form = $('#form-simpan-feedback')[0];
    var data = new FormData(form);
    var formPenyidikPenerima = $('#form-simpan-feedback');
    var insert_url = formPenyidikPenerima.attr('action');
    var method = formPenyidikPenerima.attr('method');
    var loader = $('#loader-simpan-feedback');
    $.ajax({
      type: method,
      enctype: 'multipart/form-data',
      url: insert_url,
  ...
  $('#form-update-penyidik-detailpermintaan-asaltakah').submit(function (event) {
    event.preventDefault();
    var form = $('#form-update-penyidik-detailpermintaan-asaltakah');
    var url = form.attr('action');
    var method = form.attr('method');
    $.ajax({
      url: url,
  ...
  $('#form-update-jeniskasus-barangbukti-mindik').submit(function (event) {
    event.preventDefault();
    event.stopImmediatePropagation();
    var form = $('#form-update-jeniskasus-barangbukti-mindik')[0];
    var data = new FormData(form);
    var formBB = $('#form-update-jeniskasus-barangbukti-mindik');
    var insert_url = formBB.attr('action');
    var method = formBB.attr('method');
    var loader = $('#loader-update-jeniskasus-barangbukti-mindik');
    $.ajax({
      type: method,
      enctype: 'multipart/form-data',
      url: insert_url,
  ...
  $('#form-update-keterangan-takah').submit(function (event) {
    event.preventDefault();
    var form = $('#form-update-keterangan-takah');
    var url = form.attr('action');
    var method = form.attr('method');
    $.ajax({
      url: url,
  ...
  $('#formBeriIzinEditTakah').on('submit', function (event) {
    event.preventDefault();
    event.stopImmediatePropagation();
    var form = $('#formBeriIzinEditTakah');
    var update_url = form.attr('action');
    var method = form.attr('method');
    $.ajax({
      url: update_url,
...
module.exports = __webpack_require__(/*! C:\laragon\www\lims-pussansiad-proto\resources\js\backend.js */"./resources/js/backend.js");
